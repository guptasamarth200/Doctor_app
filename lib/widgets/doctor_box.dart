...
class DoctorBox extends StatelessWidget {
  const DoctorBox({ Key? key, required this.index, required this.doctor, required this.onTap}) : super(key: key);
  final int index;
  final doctor;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.star, color: Colors.yellowAccent[700], size: 14,),
